<?php
include("../dbconn/fdata_ode_on_codes.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<link href="https://fonts.googleapis.com/css2?family=Raleway:wght@300&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="..\style\ode_on_codes.css">
</head>
<body>
  <div class="container">
    <div class="left">
    ...
    <div class="right">
      ...
      <div class='avatar-container'>
        ...
        <div class='name-box'><b>
          <p id='pname' class='avatar-name' >$name</p></b>"."
      ...
      <div class="quiz-container">
        ...
        <div class="question">
        <div class='ques'><?php echo $data['question']; ?></div>
          <p id="question"><?php echo $data['code']; ?></p>
        </div>
        ...
        <div id="btn-container">
           <div class="buttons">
           <button class="button" id="previous" onclick="previousQuestion(-1);"><img src="../images/previous.png" draggable="false" class="pn" alt=""></button>
             <button class="button" id="next" onclick="nextQuestion(+1);"><img class="pn" src="../images/next.png" draggable="false" alt=""></button>
           </div>
  ...
  <script src="../script/ode_on_codes.js"></script>
