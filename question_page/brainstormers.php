<?php
include("../dbconn/fdata_brainstormers.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="right">
      ...
      <div class="quiz-container">
        ...
        <div id="btn-container">
           <div class="buttons">
           <button class="button" id="previous" onclick="previousQuestion(-1);"><img src="../images/previous.png" class="pn" draggable="false" alt=""></button>
  ...
  <script src="../script/brainstormers.js"></script>
</body>
</html>